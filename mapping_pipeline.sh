...
# Rename to lose all extra barcodes etc. Use '-n' flag to check it works before
...
# Map to reference w/ BWA-MEM. Wih single file input do reads need to be interleaved? Change FLASH output format.
